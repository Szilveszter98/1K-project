...
$query = "SELECT * FROM blog_posts WHERE ID=:id LIMIT 1";
    ...
    if(isset($_SESSION['Role']) && $_SESSION['Role'] == 'Admin'){
        ...
        echo "<a href='views/editForm.php?action=update&id=" . $post['ID'] . "'>Update</a>";
...
while($comment= $sth->fetch()){
    ...
    if(isset($_SESSION['Role']) && $_SESSION['Role'] == 'Admin'){
        ...
        echo "<a href='includes/handlecomments.php?action=deletecomment&id=" . $comment['ID'] . "'>Delete Comment</a></br>";
